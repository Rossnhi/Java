import java.awt.*;
import java.applet.*;
/* <applet code = "spirograph2" width = 1000 height = 800>
   </applet> */
public class spirograph2 extends Applet 
{ public void paint(Graphics g)
  { g.fillRect(0, 0, 1000, 800);
    double r1 = 420; // radius of stationary circle
    double r2 = -252; // radius of moving circle
    int r = 252; // offset
    for ( int j = r; j >= 0; j -= 20)
